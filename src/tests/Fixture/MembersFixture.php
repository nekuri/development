...
class MembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'secret_kind' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'secret_question' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-11-05 12:36:23',
            'modified' => '2017-11-05 12:36:23'
        ],
    ];
}
