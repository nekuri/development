...
class AppController extends Controller
{
     ...
     * @return object
     */
    public function callAnimeApi($year, $cool)
    {
        try {
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, Configure::read('Api.anime_api') . "$year/$cool");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            $data = curl_exec($ch);

            if (!$data) {
                throw new Exception(Configure::read('Api.error_message'));
            }
